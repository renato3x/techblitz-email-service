...
export const SendUserPasswordUpdatedEmailSchema = z.object({
  username: z
...
export class SendUserPasswordUpdatedEmailDto extends createZodDto(SendUserPasswordUpdatedEmailSchema) {}
