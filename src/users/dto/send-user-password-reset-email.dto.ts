...
export const SendUserPasswordResetEmailSchema = z.object({
  username: z
...
export class SendUserPasswordResetEmailDto extends createZodDto(SendUserPasswordResetEmailSchema) {}
